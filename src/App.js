...
//We know building in one component is not idea, but until 
//we study props and  context and useEffect, we're doing to
// do this all in one component.
...
function App() {
  ...
  const getAllCandy = () => {
    fetch('https://express-firestore-yc.web.app/candy')
  ...
  const addNewCandy = (e) => {
    ...
    fetch('https://express-firestore-yc.web.app/candy', {
      method:"POST", // if method not specified, assumues 'GET'
      headers: {
